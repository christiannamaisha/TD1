...
?>
      <div class="container mt-5">
            <div class="card my-5">
                <div class="card-body">
                    <h4 class="card-title text-center text-danger font-weight-bold">Formulaire de connexion</h4>
                      ...
                      <?php endif ?>
                    <form class="my-2 mx-5 w-75 text-danger" action="<?=WEB_ROOT?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-2 offset-md-10">
                                    <button type="submit" class="btn btn-danger" name="btn_submit" value="btn_login">Connexion</button>
                                </div>
                            </div>
