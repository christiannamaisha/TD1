...
?>
      <div class="container mt-5">
            <div class="card my-5">
                <div class="card-body">
                    <h4 class="card-title text-center text-danger font-weight-bold">Formulaire d'inscription</h4>
                      ...
                      <input type="hidden" name="controller" value="security">
                            <div class="row text-danger">
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <input type="date" id="" class="form-control text-danger" name="date" aria-describedby="helpId">
                            ...
                            <div class="form-group text-danger">
                                <label for="">Role</label>
                                    <select class="form-control text-danger" name="role" id="">
                                        <option value="ROLE_ADMIN">Admin</option>
                                        <option value="ROLE_LECTEUR">Lecteur</option>
                                        <option value="ROLE_REDACTEUR">Rédacteur</option>
                                        <option value="ROLE_GESTIONAIRE">Gestionnaire</option>
                                    </select>
                            </div>
                            <div class="row">
                                <div class="col-md-2 offset-md-10">
                                    <button type="submit" class="btn btn-danger" name="btn_submit" value="btn_register">Inscription</button>
                                </div>
                            </div>
